...
namespace OIV
{
    ...
    protected:
        ...
        {
            D3D11Error::HandleDeviceError(GetDevice()->GetdDevice()->CreatePixelShader(GetShaderData()->buffer, GetShaderData()->size, nullptr, fPixelShader.ReleaseAndGetAddressOf())

...
namespace LLUtils
{
    ...
    private:
        ...
        const time_type_real multiplierMapReal      [TimeUnitCount] = { 0, 1 , 0.001 , 0.000001 ,0.000000001};
        const base_clock_rep multiplierMapInteger   [TimeUnitCount] = { 0, 1 , 1000  , 1000000  ,1000000000 };

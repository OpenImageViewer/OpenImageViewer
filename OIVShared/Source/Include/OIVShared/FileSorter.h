    ...
    class FileSorter
    {
      ...
      public:
        ...
        bool operator()(const std::wstring& A, const std::wstring& B) const
        {
            ...
            {
                case SortType::Date:
                    return fFileDateSorter(A, B, GetActiveSortDirection());
                    break;
                case SortType::Name:
                    return fFileNameSorter(A, B, GetActiveSortDirection());
                    break;
                case SortType::Extension:
                    return fFileExtensionSorter(A, B, GetActiveSortDirection());
                default:
        ...
        void SetSortType(SortType sortType) { fSortType = sortType; }

        SortType GetSortType() const { return fSortType; }

        SortDirection GetActiveSortDirection() const { return fSortDirection[static_cast<size_t>(fSortType)]; }
        ...
        void SetActiveSortDirection(SortDirection sortDirection) { SetSortDirection(fSortType, sortDirection); }

      private:

        SortType fSortType = SortType::Name;
        std::array<SortDirection, static_cast<size_t>(SortType::Count)> fSortDirection{SortDirection::Ascending,

...
namespace IMUtil
{
    ...
    ImageUtil::MapConvertKeyToFunc ImageUtil::sConvertionFunction
    {
        ...
        ,{ ConvertKey(IMCodec::TF_I_A8,          IMCodec::TF_I_R8_G8_B8_A8),PixelUtil::A8ToRGBA32 }
        ,{ ConvertKey(IMCodec::TF_I_R8_G8_B8_A8, IMCodec::TF_I_B8_G8_R8_A8),PixelUtil::RGBA32ToBGRA32 }
    };
}

...
namespace OIV
{
    ...
    void TestApp::UpdateTitle()
    {
        auto GetBuildTimeStamp = []()-> std::wstring
        {
            ...
            if (LLUtils::PlatformUtility::GetOSVersion().major >= 10 && LLUtils::PlatformUtility::GetOSVersion().major >  15063 /*Version 1703*/)
            {
                ...
                systemTime = std::chrono::clock_cast<std::chrono::system_clock>(std::filesystem::last_write_time(LLUtils::PlatformUtility::GetDllPath()));
            }
            else
            {

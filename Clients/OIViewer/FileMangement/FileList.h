...
namespace OIV
{
    ...
    class FileList
    {
      public:
        ...
        FileList(IFileListProvider* fileListProvider, FileWatcher* fileWatcher, FileSorter* fileSorter,
        ...
        index_type IsMarkerIndex(index_type index) const;
        ...
        FileWatcher::FolderID GetFolderID() const;

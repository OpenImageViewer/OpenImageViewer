...
namespace OIV
{
    FileList::FileList(IFileListProvider* fileListProvider, FileWatcher* fileWatcher, FileSorter* fileSorter,
    ...
    FileList::index_type FileList::IsMarkerIndex(index_type index) const
    {
    ...
    FileWatcher::FolderID FileList::GetFolderID() const
    {
        return fFolderID;
    }
    ...
    void FileList::OnFileChanged(FileWatcher::FileChangedEventArgs fileChangedEventArgs)  // callback from file watcher
    {
    ...
    void FileList::UpdateFileList(FileWatcher::FileChangedOp fileOp, const std::wstring& filePath,

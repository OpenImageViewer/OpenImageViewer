...
static psd_status psd_image_load_tag(psd_context ** dst_context, psd_char * buffer,size_t size, psd_load_tag load_tag)
{
	psd_context * context;
	psd_status status;
...
psd_status psd_image_load_merged(psd_context ** dst_context, psd_char * buffer,size_t size)
{
	return psd_image_load_tag(dst_context, buffer, size , psd_load_tag_merged);
}
